...
export default function About() {
  const [btnstyle, setBtnstyle] = useState("Disable dark Mode");
        ...
        <div className="accordion-item">
          ...
          >
            <div className="accordion-body" style={currentStyle}>
              <strong>
                This is the first item's accordicollapseTwoclasson body.
              </strong>{" "}
